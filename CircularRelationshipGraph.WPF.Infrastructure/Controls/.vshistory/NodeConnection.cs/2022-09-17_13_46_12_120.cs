...
namespace CircularRelationshipGraph
{
    public partial class NodeConnection : Control
    {
        ...
        private partial void OnFromPropertyChanged(DependencyPropertyChangedEventArgs e)
        {
            UpdateViewModel();
        }

        private partial void OnToPropertyChanged(DependencyPropertyChangedEventArgs e)
        {
            UpdateViewModel();
        }

        private partial void OnViaPropertyChanged(DependencyPropertyChangedEventArgs e)
        {
            UpdateViewModel();
        }
